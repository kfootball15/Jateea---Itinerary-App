...
var tokenSecret = require(path.join(__dirname, '../env')).TOKEN_SECRET
...
exports.authGoogle = function(req, res) {
  ...
  var params = {
    ...
    client_id: currentEnvironment.GOOGLE.clientID,
    client_secret: currentEnvironment.GOOGLE.clientSecret,
    redirect_uri: req.body.redirectUri,
